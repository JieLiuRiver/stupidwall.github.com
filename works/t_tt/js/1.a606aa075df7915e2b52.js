...
// EXTERNAL MODULE: ./node_modules/_swiper@4.0.7@swiper/dist/css/swiper.css
var swiper = __webpack_require__("7Pw6");
var swiper_default = /*#__PURE__*/__webpack_require__.n(swiper);

// EXTERNAL MODULE: ./node_modules/_vue-awesome-swiper@3.0.4@vue-awesome-swiper/dist/vue-awesome-swiper.js
var vue_awesome_swiper = __webpack_require__("m0xk");
var vue_awesome_swiper_default = /*#__PURE__*/__webpack_require__.n(vue_awesome_swiper);

// EXTERNAL MODULE: ./node_modules/_better-scroll@0.4.0@better-scroll/dist/bscroll.js
var bscroll = __webpack_require__("tGS0");
var bscroll_default = /*#__PURE__*/__webpack_require__.n(bscroll);

// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.2@babel-loader/lib!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=script&index=0!./src/components/scroll_view.vue
//
//
//
//
...
/* harmony default export */ var scroll_view = ({
  props: {
    /**
  ...
  methods: {
    _initScroll: function _initScroll() {
      ...
      // better-scroll的初始化
      this.scroll = new bscroll_default.a(this.$refs.wrapper, {
...
// CONCATENATED MODULE: ./node_modules/_vue-loader@13.5.0@vue-loader/lib/template-compiler?{"id":"data-v-190ce17c","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=template&index=0!./src/components/scroll_view.vue
...
/* harmony default export */ var components_scroll_view = (esExports);
// CONCATENATED MODULE: ./src/components/scroll_view.vue
...
/* harmony default export */ var src_components_scroll_view = (Component.exports);

// EXTERNAL MODULE: ./src/bus.js
var bus = __webpack_require__("14gb");

// EXTERNAL MODULE: ./src/components/title_header.vue + 2 modules
var title_header = __webpack_require__("Y1g1");

// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.2@babel-loader/lib!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=script&index=0!./src/components/swiper_static.vue
//
//
//
//
...
/* harmony default export */ var swiper_static = ({
    props: {
        dataList: {
            type: Array,
...
// CONCATENATED MODULE: ./node_modules/_vue-loader@13.5.0@vue-loader/lib/template-compiler?{"id":"data-v-ac6aca60","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=template&index=0!./src/components/swiper_static.vue
var swiper_static_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('swiper',{staticClass:"swiper-static-box f-hf",attrs:{"options":_vm.swiperOption}},[_vm._t("default")],2)],1)}
var swiper_static_staticRenderFns = []
var swiper_static_esExports = { render: swiper_static_render, staticRenderFns: swiper_static_staticRenderFns }
/* harmony default export */ var components_swiper_static = (swiper_static_esExports);
// CONCATENATED MODULE: ./src/components/swiper_static.vue
function injectStyle (ssrContext) {
  __webpack_require__("yj7S")
}
var swiper_static_normalizeComponent = __webpack_require__("/Xao")
/* script */

/* template */

/* template functional */
var swiper_static___vue_template_functional__ = false
/* styles */
var swiper_static___vue_styles__ = injectStyle
/* scopeId */
var swiper_static___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var swiper_static___vue_module_identifier__ = null
var swiper_static_Component = swiper_static_normalizeComponent(
  swiper_static,
  components_swiper_static,
  swiper_static___vue_template_functional__,
  swiper_static___vue_styles__,
  swiper_static___vue_scopeId__,
  swiper_static___vue_module_identifier__
)

/* harmony default export */ var src_components_swiper_static = (swiper_static_Component.exports);

// EXTERNAL MODULE: ./node_modules/_underscore@1.8.3@underscore/underscore.js
var underscore = __webpack_require__("u47Y");
var underscore_default = /*#__PURE__*/__webpack_require__.n(underscore);

// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.2@babel-loader/lib!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=script&index=0!./src/views/home.vue
//
//
//
//
...
/* harmony default export */ var home = ({
    data: function data() {
        return {
            ...
            resourceJson: bus["a" /* default */].indexResourcelist,
            screenHeight: 0,
            productSkusList: bus["a" /* default */].indexProductSkuslist
        };
    },
    mounted: function mounted() {
        var _this = this;
        ...
        window.addEventListener('resize', function () {
            return _this.screenHeight = WINDOW_HEIGHT;
        });
        this.$nextTick(function () {
            _this.screenHeight = WINDOW_HEIGHT;
            _this._initScroll();
        });
    },

    methods: {
        findList: function findList(key, attr) {
            var _this2 = this;

            var list = underscore_default.a.clone(this.productSkusList),
                result = [];
            list.forEach(function (item) {
                var _list = typeof attr === 'undefined' ? _this2.resourceJson.floors[key].dataList : _this2.resourceJson.floors[key].dataList[attr];
    ...
    computed: {
        hotSwiperWrapperStyles: function hotSwiperWrapperStyles() {
            return {
                // width: this.hotSwiperWrapperHeight + 100 + 'px'
            };
        },
        hotProductList: function hotProductList() {
            return this.findList(0);
        },
        hotSalePhoneList: function hotSalePhoneList() {
            return this.findList(2);
        },
        carouseList: function carouseList() {
            return this.findList(3, 'carousel');
        },
        goodsList: function goodsList() {
            return this.findList(3, 'recommend');
        },
        carefulChoseList: function carefulChoseList() {
            return this.findList(5);
        },
        layoutImageList: function layoutImageList() {
    ...
    components: {
        ...
        vScrollView: src_components_scroll_view,
        vTitleHeader: title_header["a" /* default */],
        vSwiperStatic: src_components_swiper_static
    }
});
// CONCATENATED MODULE: ./node_modules/_vue-loader@13.5.0@vue-loader/lib/template-compiler?{"id":"data-v-76a85659","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=template&index=0!./src/views/home.vue
var home_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"app-container"},[_c('section',{staticClass:"section-floor layout-banner"},[(typeof _vm.resourceJson.banner !== 'undefined' && _vm.resourceJson.banner.dataList.length)?_c('div',{staticClass:"banner-container"},[_c('swiper',{staticClass:"swiper-box f-hf",attrs:{"options":_vm.swiperOption}},[_vm._l((_vm.resourceJson.banner.dataList),function(o,i){return _c('swiper-slide',{key:o.src,staticClass:"swiper-item f-wf"},[_c('a',{staticClass:"f-ib swiper-link",attrs:{"href":o.linkUrl}},[_c('img',{attrs:{"width":"100%","height":"100%","src":o.src}})])])}),_vm._v(" "),_c('div',{staticClass:"swiper-pagination",attrs:{"slot":"pagination"},slot:"pagination"})],2)],1):_vm._e(),_vm._v(" "),_c('div',{staticClass:"short-cut-container"},_vm._l((_vm.resourceJson.shortcut.dataList),function(o,i){return _c('div',{key:o.linkUrl,staticClass:"short-cut"},[_c('a',{staticClass:"f-ib f-wf short-cut-link f-flex f-drc f-aic",attrs:{"href":o.linkUrl}},[_c('img',{staticClass:"f-b",attrs:{"src":o.src,"alt":o.labelTitle}}),_vm._v(" "),_c('p',{staticClass:"f-ellipsis f-fs12"},[_vm._v(_vm._s(o.labelTitle))])])])}))]),_vm._v(" "),_c('section',{staticClass:"section-floor"},[_c('v-title-header',{attrs:{"title":"热门商品","arrow":true,"route":"login"}}),_vm._v(" "),_c('v-swiper-static',_vm._l((_vm.hotProductList),function(o,i){return _c('swiper-slide',{key:o.src,staticClass:"hot-swiper-item f-flex f-drr f-jc-start f-nowrap"},[_c('div',{staticClass:"hot-product-item f-wf "},[_c('a',{staticClass:"f-b f-hf f-wf link f-pr app-1px",attrs:{"href":"javascript:;"}},[_c('img',{attrs:{"width":"99%","height":"99%","src":o.shop_info.ali_image}})]),_vm._v(" "),_c('div',{staticClass:"item-content"},[_c('h4',{staticClass:"f-fs12 title"},[_vm._v(_vm._s(o.product_info.product_name))]),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-ellipsis desc"},[_vm._v(_vm._s(o.shop_info.sub_title))]),_vm._v(" "),_c('p',{staticClass:"price"},[_c('span',{staticClass:"f-ib symbol"},[_vm._v("¥")]),_c('span',{staticClass:"f-ib"},[_vm._v(_vm._s(o.price))])])])])])}))],1),_vm._v(" "),_c('section',{staticClass:"section-floor"},[_c('v-title-header',{attrs:{"title":"热销机型","arrow":false,"route":"login"}}),_vm._v(" "),_c('swiper',{staticClass:"hotsale-swiper-box f-hf",attrs:{"options":_vm.hotSaleSwiperOption}},[_vm._l((_vm.hotSalePhoneList),function(o,i){return _c('swiper-slide',{key:o.shop_info.ali_image,staticClass:"hotsale-swiper-item"},[_c('a',{staticClass:"f-ib hotsale-swiper-link f-wf f-hf",attrs:{"href":o.linkUrl}},[_c('img',{attrs:{"width":"100%","height":"100%","src":o.shop_info.ali_image}})]),_vm._v(" "),_c('div',{staticClass:"item-content f-flex f-drc f-jcc f-aic"},[_c('h4',{staticClass:"f-fs12 title"},[_vm._v(_vm._s(o.shop_info.title))]),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-ellipsis desc"},[_vm._v(_vm._s(o.shop_info.sub_title))]),_vm._v(" "),_c('p',{staticClass:"price"},[_c('span',{staticClass:"f-ib symbol"},[_vm._v("¥")]),_c('span',{staticClass:"f-ib"},[_vm._v(_vm._s(o.price))])])])])}),_vm._v(" "),_c('div',{staticClass:"hotsale-swiper-pagination",attrs:{"slot":"pagination"},slot:"pagination"})],2)],1),_vm._v(" "),_c('section',{staticClass:"section-floor"},[_c('v-title-header',{attrs:{"title":"净化器配件","arrow":true,"route":"login"}}),_vm._v(" "),_c('swiper',{staticClass:"carouse-swiper-box f-hf f-bottom-line",attrs:{"options":_vm.carouseSwiperOption}},_vm._l((_vm.carouseList),function(o,i){return _c('swiper-slide',{key:o.shop_info.ali_image,staticClass:"carouse-swiper-item"},[_c('a',{staticClass:"f-ib carouse-swiper-link f-wf f-hf",attrs:{"href":o.linkUrl}},[_c('img',{attrs:{"width":"100%","height":"100%","src":o.shop_info.ali_image}})]),_vm._v(" "),_c('div',{staticClass:"item-content f-flex f-drc f-jcc f-aic"},[_c('h4',{staticClass:"f-fs12 title"},[_vm._v(_vm._s(o.shop_info.title))]),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-ellipsis desc"},[_vm._v(_vm._s(o.shop_info.sub_title))]),_vm._v(" "),_c('p',{staticClass:"price"},[_c('span',{staticClass:"f-ib symbol"},[_vm._v("¥")]),_c('span',{staticClass:"f-ib"},[_vm._v(_vm._s(o.price))])])])])})),_vm._v(" "),_c('ul',{staticClass:"goods-list f-flex f-drr f-aic f-wrap"},_vm._l((_vm.goodsList),function(row,index){return _c('li',{key:index,staticClass:"goods-item f-fs12 f-flex f-drr f-nowrap f-aic f-pr",class:( _obj = {}, _obj['f-bottom-line'] = index < 2, _obj['f-right-line'] = (index=== 0 || index === 2), _obj )},[_c('img',{staticClass:"f-b goods-image",attrs:{"src":row.shop_info.ali_image}}),_vm._v(" "),_c('p',{staticClass:"f-ellipsis"},[_vm._v(_vm._s(row.product_info.goods_name))]),_vm._v(" "),_c('i',{staticClass:"f-b ion-ios-arrow-right"})])
var _obj;}))],1),_vm._v(" "),_c('section',{staticClass:"section-floor"},[_c('v-title-header',{attrs:{"title":"官方精选","arrow":true,"route":"login"}}),_vm._v(" "),_c('div',{staticClass:"careful-chose-wrap"},[_c('ul',{staticClass:"careful-chose-list f-flex f-drr f-wrap faic f-jc-between"},_vm._l((_vm.carefulChoseList),function(o,i){return _c('li',{key:i,staticClass:"careful-chose-item"},[_c('div',{staticClass:"f-wf careful-chose-inner"},[_c('router-link',{staticClass:"f-ib f-wf link f-pr app-1px",attrs:{"to":"/login"}},[_c('img',{staticClass:"f-pa",attrs:{"width":"100%","height":"100%","src":o.shop_info.ali_image}})])],1),_vm._v(" "),_c('div',{staticClass:"item-content"},[_c('h4',{staticClass:"f-fs12 title"},[_vm._v(_vm._s(o.product_info.product_name))]),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-ellipsis desc"},[_vm._v(_vm._s(o.shop_info.sub_title))]),_vm._v(" "),_c('p',{staticClass:"price"},[_c('span',{staticClass:"f-ib symbol"},[_vm._v("¥")]),_c('span',{staticClass:"f-ib"},[_vm._v(_vm._s(o.price))])])])])}))])],1),_vm._v(" "),_c('section',{staticClass:"section-floor layout-image f-flex f-drc f-aic"},_vm._l((_vm.layoutImageList),function(o,i){return _c('div',{key:i,staticClass:"layout-image-item"},[_c('a',{staticClass:"f-ib f-wf f-hf",attrs:{"href":o.linkUrl}},[_c('img',{attrs:{"width":"100%","height":"100%","src":o.src}})])])})),_vm._v(" "),_c('section',{staticClass:"section-floor"}),_vm._v(" "),_c('section',{staticClass:"section-floor"},[_c('v-title-header',{attrs:{"title":"品牌精选","arrow":true,"route":"login"}}),_vm._v(" "),_c('div',{staticClass:"careful-chose-wrap"},[_c('ul',{staticClass:"careful-chose-list f-flex f-drr f-wrap faic f-jc-between"},_vm._l((_vm.brandList),function(o,i){return _c('li',{key:i,staticClass:"careful-chose-item"},[_c('div',{staticClass:"f-wf careful-chose-inner"},[_c('router-link',{staticClass:"f-ib f-wf link f-pr app-1px",attrs:{"to":"/login"}},[_c('img',{staticClass:"f-pa",attrs:{"width":"100%","height":"100%","src":o.shop_info.ali_image}})])],1),_vm._v(" "),_c('div',{staticClass:"item-content"},[_c('h4',{staticClass:"f-fs12 title"},[_vm._v(_vm._s(o.product_info.product_name))]),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-ellipsis desc"},[_vm._v(_vm._s(o.shop_info.sub_title))]),_vm._v(" "),_c('p',{staticClass:"price"},[_c('span',{staticClass:"f-ib symbol"},[_vm._v("¥")]),_c('span',{staticClass:"f-ib"},[_vm._v(_vm._s(o.price))])])])])}))])],1)])}
...
function home_injectStyle (ssrContext) {
  __webpack_require__("8/3K")
}
var home_normalizeComponent = __webpack_require__("/Xao")
/* script */
...
/* scopeId */
var home___vue_scopeId__ = "data-v-76a85659"
/* moduleIdentifier (server only) */
...
/* harmony default export */ var src_views_home = __webpack_exports__["default"] = (home_Component.exports);
...
// load the styles
var content = __webpack_require__("jRWt");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("8bSs")("0cd9dfb7", content, true);
...
// load the styles
var content = __webpack_require__("8Pos");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("8bSs")("2ceaf572", content, true);
...
// load the styles
var content = __webpack_require__("iU+C");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("8bSs")("1986e22b", content, true);
...
// module
exports.push([module.i, "\n.app-container[data-v-76a85659] {\n  padding-bottom: .5rem;\n}\n.app-container .section-floor[data-v-76a85659] {\n  position: relative;\n  -webkit-box-shadow: 0 5px 13px rgba(0, 0, 0, 0.18);\n          box-shadow: 0 5px 13px rgba(0, 0, 0, 0.18);\n  margin-bottom: 8px;\n  background: #fff;\n}\n.app-container .section-floor .banner-container[data-v-76a85659] {\n  height: 1.45rem;\n  margin: 0.18rem 0.14rem;\n  border-radius: 0.1rem;\n}\n.app-container .section-floor .swiper-link[data-v-76a85659] {\n  height: 1.45rem;\n}\n.app-container .layout-banner[data-v-76a85659] {\n  overflow: hidden;\n}\n.app-container .swiper-pagination[data-v-76a85659] {\n  height: 10px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .short-cut-container[data-v-76a85659] {\n  margin: 0.2rem 0.14rem;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: distribute;\n      justify-content: space-around;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .short-cut-link[data-v-76a85659] {\n  height: 0.52rem;\n}\n.app-container .short-cut-link img[data-v-76a85659] {\n  width: 0.25rem;\n  height: 0.25rem;\n}\n.app-container .short-cut-link p[data-v-76a85659] {\n  margin-top: 0.1rem;\n}\n.app-container .hot-swiper-item[data-v-76a85659] {\n  border-radius: 0.10rem;\n}\n.app-container .hot-swiper-item[data-v-76a85659]:last-child {\n  padding-right: 0;\n}\n.app-container .hot-product-item .link[data-v-76a85659] {\n  height: 1.25rem;\n}\n.app-container .hot-product-item .link[data-v-76a85659]:before {\n  border-radius: 0.1rem;\n}\n.app-container .hot-product-item .link img[data-v-76a85659] {\n  border-radius: 0.04rem;\n  left: 0;\n  top: 0;\n}\n.app-container .item-content[data-v-76a85659] {\n  padding: .10rem .14rem;\n}\n.app-container .title[data-v-76a85659] {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  margin: 0;\n  font-size: .12rem;\n  color: #333;\n  font-weight: 700;\n}\n.app-container .desc[data-v-76a85659] {\n  text-align: left;\n  margin-top: 0.05rem;\n  color: #7f7f7f;\n}\n.app-container .price[data-v-76a85659] {\n  margin-top: .05rem;\n  color: #d44d44;\n  white-space: nowrap;\n  font-weight: 700 !important;\n  font-size: .12rem;\n}\n.app-container .price .symbol[data-v-76a85659] {\n  -webkit-transform: scale(0.83333);\n  transform: scale(0.83333);\n  -webkit-transform-origin: bottom right;\n  transform-origin: bottom right;\n  padding-right: 0.04rem;\n}\n.app-container .price .origin-price[data-v-76a85659] {\n  color: #7f7f7f;\n  font-size: 0.05rem;\n}\n.app-container .price .origin-price .symbol[data-v-76a85659] {\n  padding-right: 0;\n}\n.app-container .price .origin-price span[data-v-76a85659] {\n  -webkit-transform: scale(0.83333);\n  transform: scale(0.83333);\n}\n.app-container .hotsale-swiper-box[data-v-76a85659] {\n  padding: 0.16rem 0;\n  margin-bottom: 0.1rem;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item[data-v-76a85659] {\n  padding: 0 0.1rem;\n  width: 3.5rem;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item .hotsale-swiper-link[data-v-76a85659] {\n  width: 100%;\n  height: 3.69rem;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content[data-v-76a85659] {\n  padding: 0;\n  margin-bottom: 10px;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content .title[data-v-76a85659],\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content desc[data-v-76a85659],\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content price[data-v-76a85659] {\n  padding: 4px 0;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-pagination[data-v-76a85659] {\n  height: 10px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .carouse-swiper-box[data-v-76a85659] {\n  margin-top: 10px;\n}\n.app-container .carouse-swiper-box .carouse-swiper-item[data-v-76a85659] {\n  margin-bottom: 30px;\n}\n.app-container .carouse-swiper-box .carouse-swiper-link[data-v-76a85659] {\n  left: 50%;\n  position: relative;\n  -webkit-transform: translate3d(-50%, 0, 0);\n          transform: translate3d(-50%, 0, 0);\n  width: 2.08rem;\n  height: 2.08rem;\n}\n.app-container .carouse-swiper-box .carouse-swiper-pagination[data-v-76a85659] {\n  height: 10px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .goods-list .goods-item[data-v-76a85659] {\n  width: 50%;\n  height: 0.625rem;\n}\n.app-container .goods-list .goods-item .goods-image[data-v-76a85659] {\n  width: 0.375rem;\n  height: 0.375rem;\n  margin: 0 0.1rem;\n}\n.app-container .goods-list .goods-item i[data-v-76a85659] {\n  padding: 0 0.1rem;\n}\n.app-container .careful-chose-wrap[data-v-76a85659] {\n  padding: 0.2rem 0.14rem;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-item[data-v-76a85659] {\n  width: 50%;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-item .link[data-v-76a85659] {\n  padding-top: 100%;\n  border-radius: 0.1rem;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-item .link img[data-v-76a85659] {\n  left: 0;\n  top: 0;\n  border-radius: 0.1rem;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-inner[data-v-76a85659] {\n  padding: 0.05rem;\n}\n.app-container .layout-image[data-v-76a85659] {\n  padding: 0.16rem 0.14rem;\n}\n.app-container .layout-image .layout-image-item[data-v-76a85659] {\n  width: 100%;\n  height: 1.34rem;\n  margin-bottom: 0.16rem;\n}\n", "", {"version":3,"sources":["/Users/heliujie/Projects/t_tt/src/views/home.vue"],"names":[],"mappings":";AACA;EACE,sBAAsB;CACvB;AACD;EACE,mBAAmB;EACnB,mDAAmD;UAC3C,2CAA2C;EACnD,mBAAmB;EACnB,iBAAiB;CAClB;AACD;EACE,gBAAgB;EAChB,wBAAwB;EACxB,sBAAsB;CACvB;AACD;EACE,gBAAgB;CACjB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,aAAa;EACb,qBAAqB;EACrB,qBAAqB;EACrB,cAAc;EACd,yBAAyB;MACrB,sBAAsB;UAClB,wBAAwB;EAChC,0BAA0B;MACtB,uBAAuB;UACnB,oBAAoB;CAC7B;AACD;EACE,uBAAuB;EACvB,qBAAqB;EACrB,qBAAqB;EACrB,cAAc;EACd,0BAA0B;MACtB,8BAA8B;EAClC,0BAA0B;MACtB,uBAAuB;UACnB,oBAAoB;CAC7B;AACD;EACE,gBAAgB;CACjB;AACD;EACE,eAAe;EACf,gBAAgB;CACjB;AACD;EACE,mBAAmB;CACpB;AACD;EACE,uBAAuB;CACxB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,gBAAgB;CACjB;AACD;EACE,sBAAsB;CACvB;AACD;EACE,uBAAuB;EACvB,QAAQ;EACR,OAAO;CACR;AACD;EACE,uBAAuB;CACxB;AACD;EACE,iBAAiB;EACjB,wBAAwB;EACxB,oBAAoB;EACpB,UAAU;EACV,kBAAkB;EAClB,YAAY;EACZ,iBAAiB;CAClB;AACD;EACE,iBAAiB;EACjB,oBAAoB;EACpB,eAAe;CAChB;AACD;EACE,mBAAmB;EACnB,eAAe;EACf,oBAAoB;EACpB,4BAA4B;EAC5B,kBAAkB;CACnB;AACD;EACE,kCAAkC;EAClC,0BAA0B;EAC1B,uCAAuC;EACvC,+BAA+B;EAC/B,uBAAuB;CACxB;AACD;EACE,eAAe;EACf,mBAAmB;CACpB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,kCAAkC;EAClC,0BAA0B;CAC3B;AACD;EACE,mBAAmB;EACnB,sBAAsB;CACvB;AACD;EACE,kBAAkB;EAClB,cAAc;CACf;AACD;EACE,YAAY;EACZ,gBAAgB;CACjB;AACD;EACE,WAAW;EACX,oBAAoB;CACrB;AACD;;;EAGE,eAAe;CAChB;AACD;EACE,aAAa;EACb,qBAAqB;EACrB,qBAAqB;EACrB,cAAc;EACd,yBAAyB;MACrB,sBAAsB;UAClB,wBAAwB;EAChC,0BAA0B;MACtB,uBAAuB;UACnB,oBAAoB;CAC7B;AACD;EACE,iBAAiB;CAClB;AACD;EACE,oBAAoB;CACrB;AACD;EACE,UAAU;EACV,mBAAmB;EACnB,2CAA2C;UACnC,mCAAmC;EAC3C,eAAe;EACf,gBAAgB;CACjB;AACD;EACE,aAAa;EACb,qBAAqB;EACrB,qBAAqB;EACrB,cAAc;EACd,yBAAyB;MACrB,sBAAsB;UAClB,wBAAwB;EAChC,0BAA0B;MACtB,uBAAuB;UACnB,oBAAoB;CAC7B;AACD;EACE,WAAW;EACX,iBAAiB;CAClB;AACD;EACE,gBAAgB;EAChB,iBAAiB;EACjB,iBAAiB;CAClB;AACD;EACE,kBAAkB;CACnB;AACD;EACE,wBAAwB;CACzB;AACD;EACE,WAAW;CACZ;AACD;EACE,kBAAkB;EAClB,sBAAsB;CACvB;AACD;EACE,QAAQ;EACR,OAAO;EACP,sBAAsB;CACvB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,yBAAyB;CAC1B;AACD;EACE,YAAY;EACZ,gBAAgB;EAChB,uBAAuB;CACxB","file":"home.vue","sourcesContent":["\n.app-container[data-v-76a85659] {\n  padding-bottom: .5rem;\n}\n.app-container .section-floor[data-v-76a85659] {\n  position: relative;\n  -webkit-box-shadow: 0 5px 13px rgba(0, 0, 0, 0.18);\n          box-shadow: 0 5px 13px rgba(0, 0, 0, 0.18);\n  margin-bottom: 8px;\n  background: #fff;\n}\n.app-container .section-floor .banner-container[data-v-76a85659] {\n  height: 1.45rem;\n  margin: 0.18rem 0.14rem;\n  border-radius: 0.1rem;\n}\n.app-container .section-floor .swiper-link[data-v-76a85659] {\n  height: 1.45rem;\n}\n.app-container .layout-banner[data-v-76a85659] {\n  overflow: hidden;\n}\n.app-container .swiper-pagination[data-v-76a85659] {\n  height: 10px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .short-cut-container[data-v-76a85659] {\n  margin: 0.2rem 0.14rem;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: distribute;\n      justify-content: space-around;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .short-cut-link[data-v-76a85659] {\n  height: 0.52rem;\n}\n.app-container .short-cut-link img[data-v-76a85659] {\n  width: 0.25rem;\n  height: 0.25rem;\n}\n.app-container .short-cut-link p[data-v-76a85659] {\n  margin-top: 0.1rem;\n}\n.app-container .hot-swiper-item[data-v-76a85659] {\n  border-radius: 0.10rem;\n}\n.app-container .hot-swiper-item[data-v-76a85659]:last-child {\n  padding-right: 0;\n}\n.app-container .hot-product-item .link[data-v-76a85659] {\n  height: 1.25rem;\n}\n.app-container .hot-product-item .link[data-v-76a85659]:before {\n  border-radius: 0.1rem;\n}\n.app-container .hot-product-item .link img[data-v-76a85659] {\n  border-radius: 0.04rem;\n  left: 0;\n  top: 0;\n}\n.app-container .item-content[data-v-76a85659] {\n  padding: .10rem .14rem;\n}\n.app-container .title[data-v-76a85659] {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  margin: 0;\n  font-size: .12rem;\n  color: #333;\n  font-weight: 700;\n}\n.app-container .desc[data-v-76a85659] {\n  text-align: left;\n  margin-top: 0.05rem;\n  color: #7f7f7f;\n}\n.app-container .price[data-v-76a85659] {\n  margin-top: .05rem;\n  color: #d44d44;\n  white-space: nowrap;\n  font-weight: 700 !important;\n  font-size: .12rem;\n}\n.app-container .price .symbol[data-v-76a85659] {\n  -webkit-transform: scale(0.83333);\n  transform: scale(0.83333);\n  -webkit-transform-origin: bottom right;\n  transform-origin: bottom right;\n  padding-right: 0.04rem;\n}\n.app-container .price .origin-price[data-v-76a85659] {\n  color: #7f7f7f;\n  font-size: 0.05rem;\n}\n.app-container .price .origin-price .symbol[data-v-76a85659] {\n  padding-right: 0;\n}\n.app-container .price .origin-price span[data-v-76a85659] {\n  -webkit-transform: scale(0.83333);\n  transform: scale(0.83333);\n}\n.app-container .hotsale-swiper-box[data-v-76a85659] {\n  padding: 0.16rem 0;\n  margin-bottom: 0.1rem;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item[data-v-76a85659] {\n  padding: 0 0.1rem;\n  width: 3.5rem;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item .hotsale-swiper-link[data-v-76a85659] {\n  width: 100%;\n  height: 3.69rem;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content[data-v-76a85659] {\n  padding: 0;\n  margin-bottom: 10px;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content .title[data-v-76a85659],\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content desc[data-v-76a85659],\n.app-container .hotsale-swiper-box .hotsale-swiper-item .item-content price[data-v-76a85659] {\n  padding: 4px 0;\n}\n.app-container .hotsale-swiper-box .hotsale-swiper-pagination[data-v-76a85659] {\n  height: 10px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .carouse-swiper-box[data-v-76a85659] {\n  margin-top: 10px;\n}\n.app-container .carouse-swiper-box .carouse-swiper-item[data-v-76a85659] {\n  margin-bottom: 30px;\n}\n.app-container .carouse-swiper-box .carouse-swiper-link[data-v-76a85659] {\n  left: 50%;\n  position: relative;\n  -webkit-transform: translate3d(-50%, 0, 0);\n          transform: translate3d(-50%, 0, 0);\n  width: 2.08rem;\n  height: 2.08rem;\n}\n.app-container .carouse-swiper-box .carouse-swiper-pagination[data-v-76a85659] {\n  height: 10px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.app-container .goods-list .goods-item[data-v-76a85659] {\n  width: 50%;\n  height: 0.625rem;\n}\n.app-container .goods-list .goods-item .goods-image[data-v-76a85659] {\n  width: 0.375rem;\n  height: 0.375rem;\n  margin: 0 0.1rem;\n}\n.app-container .goods-list .goods-item i[data-v-76a85659] {\n  padding: 0 0.1rem;\n}\n.app-container .careful-chose-wrap[data-v-76a85659] {\n  padding: 0.2rem 0.14rem;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-item[data-v-76a85659] {\n  width: 50%;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-item .link[data-v-76a85659] {\n  padding-top: 100%;\n  border-radius: 0.1rem;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-item .link img[data-v-76a85659] {\n  left: 0;\n  top: 0;\n  border-radius: 0.1rem;\n}\n.app-container .careful-chose-wrap .careful-chose-list .careful-chose-inner[data-v-76a85659] {\n  padding: 0.05rem;\n}\n.app-container .layout-image[data-v-76a85659] {\n  padding: 0.16rem 0.14rem;\n}\n.app-container .layout-image .layout-image-item[data-v-76a85659] {\n  width: 100%;\n  height: 1.34rem;\n  margin-bottom: 0.16rem;\n}\n"],"sourceRoot":""}]);
...
// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.2@babel-loader/lib!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=script&index=0!./src/components/title_header.vue
//
//
//
//
...
/* harmony default export */ var title_header = ({
    props: ['title', 'arrow', 'route'],
    data: function data() {
        return {};
    }
});
// CONCATENATED MODULE: ./node_modules/_vue-loader@13.5.0@vue-loader/lib/template-compiler?{"id":"data-v-4a354368","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=template&index=0!./src/components/title_header.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('router-link',{staticClass:"f-ib t-h-container f-wf f-flex f-drr f-jcc f-aic f-pr f-bottom-line f-top-line",attrs:{"to":{name:_vm.route}}},[_c('h2',{staticClass:"f-hf f-wf"},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),(_vm.arrow)?_c('i',{staticClass:"ion-ios-arrow-right icon"}):_vm._e()])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var components_title_header = (esExports);
// CONCATENATED MODULE: ./src/components/title_header.vue
function injectStyle (ssrContext) {
  __webpack_require__("8LmV")
}
var normalizeComponent = __webpack_require__("/Xao")
/* script */
...
/* harmony default export */ var src_components_title_header = __webpack_exports__["a"] = (Component.exports);
...
// module
exports.push([module.i, "\n.swiper-static-box {\n  padding: 0.2rem 0.14rem;\n}\n", "", {"version":3,"sources":["/Users/heliujie/Projects/t_tt/src/components/swiper_static.vue"],"names":[],"mappings":";AACA;EACE,wBAAwB;CACzB","file":"swiper_static.vue","sourcesContent":["\n.swiper-static-box {\n  padding: 0.2rem 0.14rem;\n}\n"],"sourceRoot":""}]);
...
// module
exports.push([module.i, "\n.t-h-container {\n  height: 0.41rem;\n  padding: 0 0.1rem;\n}\n.t-h-container h2 {\n  font-weight: 700;\n  color: #666;\n  font-size: 0.16rem;\n  line-height: 0.41rem;\n}\n.t-h-container .icon {\n  font-size: 0.16rem;\n  color: #666;\n  font-weight: bolder;\n}\n", "", {"version":3,"sources":["/Users/heliujie/Projects/t_tt/src/components/title_header.vue"],"names":[],"mappings":";AACA;EACE,gBAAgB;EAChB,kBAAkB;CACnB;AACD;EACE,iBAAiB;EACjB,YAAY;EACZ,mBAAmB;EACnB,qBAAqB;CACtB;AACD;EACE,mBAAmB;EACnB,YAAY;EACZ,oBAAoB;CACrB","file":"title_header.vue","sourcesContent":["\n.t-h-container {\n  height: 0.41rem;\n  padding: 0 0.1rem;\n}\n.t-h-container h2 {\n  font-weight: 700;\n  color: #666;\n  font-size: 0.16rem;\n  line-height: 0.41rem;\n}\n.t-h-container .icon {\n  font-size: 0.16rem;\n  color: #666;\n  font-weight: bolder;\n}\n"],"sourceRoot":""}]);
...
// load the styles
var content = __webpack_require__("dkrz");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("8bSs")("0ea19dcb", content, true);
...
//# sourceMappingURL=1.a606aa075df7915e2b52.js.map